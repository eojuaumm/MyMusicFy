...
import Dashboard from "@/components/Dashboard"; // Importa o componente novo
...
export default async function Home() {
  ...
  return (
    <main className="min-h-screen bg-gray-950 text-white selection:bg-blue-500/30">
      ...
      {!session?.user ? (
        // ... (Mantém a Landing Page igualzinha à anterior, não mudou nada aqui) ...
        ...
        // AQUI MUDOU: Chamamos o Dashboard que tem o Player
