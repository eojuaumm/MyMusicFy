...
// AQUI ESTAVA O ERRO: Faltava importar o 'alternarPlano'
...
export default async function PerfilPage() {
  ...
  // Busca os dados ATUAIS do usuário no banco (incluindo o isPro)
    ...
    <main className="min-h-screen bg-gray-950 text-white">
      ...
      <div className="max-w-2xl mx-auto p-6 mt-10">
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-2xl p-8 shadow-2xl">
          ...
          {/* Mostra a foto atual ou uma bolinha com a inicial */}
          ...
          <form action={atualizarPerfil} className="flex flex-col gap-6">
            {/* Campo oculto para sabermos QUEM estamos editando */}
            <input type="hidden" name="emailAtual" value={usuario.email} />

            {/* SECÇÃO 1: DADOS PÚBLICOS */}
          ...
          <div className="mt-12 pt-8 border-t border-gray-800">
            <div className="flex items-center justify-between">
              ...
              {/* Agora sim, alternarPlano está importado e vai funcionar */}
